...
public class PlayerController : MonoBehaviour
{
    ...
    //In order to do anyting, we cannot be frozen (timer must be 0)
    ...
    private void Awake()
    {
        ...
        for (int i = 0; i < m_Attacks.Length; i++)
        {
            ...
            {
                Debug.LogError(attack.AttackName + " has a wind up time that is larger than the amoung of time that the player is frozen for");
            }
        }
    }
    ...
    private void Update()
    {
        ...
        // Set how hard the playr is pressing movement buttons
    ...
    {
        if (other.CompareTag("Health Pill"))
        {
